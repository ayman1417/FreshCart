...
export default function ProductsCategory() {
    ...
    async function getProducts(id) {
        const res = await axios.get(`${baseUrl}/api/v1/products?category=${id}`);
        return res.data.data; // Return only the product data
    }


    const { data: products, error, isError, isLoading } = useQuery({
        queryKey: ["productCategory", id], // Include categoryID as part of the query key
    ...
    return (
        <div className='mt-10'>
            ...
            >
                ...
                <h1 className=' text-center text-5xl font-bold mb-10'>{products[0]?.category.name}</h1>
